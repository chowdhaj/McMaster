 ...
 * Note: This program is identical to 'sorting.c', except for the
 *       unsorted array and its size. 
 *
...
#define SIZE_ARRAY         13  // Define a constant number: 13
...
int unsorted_arr[SIZE_ARRAY] = {7, 12, 19, 23, 3, 18, 4,
                                2, 6, 15, 1, 8};
